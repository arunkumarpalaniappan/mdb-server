...
exports.list = function () {
    ...
    return new Promise((resolve, reject) => {
        const cursor = collection.find({}).project({ "_id": true, "original_title": true, "poster_path": true, "spoken_languages": true }).sort({ $natural: 1 }).skip((parseInt(this.p) - 1) * 20).limit(20); // sort,skip first n and get the response
